...
// @ts-ignore
import IDL from "../target/idl/ladyfinger.json";
import { BankrunContextWrapper } from "../bankrun-utils/bankrunConnection";
import { Ladyfinger } from "@project/anchor";
...
describe("Lending Smart Contract Tests", async () => {
  ...
  let program: Program<Ladyfinger>;
  ...
  program = new Program<Ladyfinger>(IDL as Ladyfinger, provider);
